...
`00-compare-all/` is the **Implementation Comparison Harness**. It is not a seventh
implementation; it is a lightweight Vite page that shows the six real implementations side by side.
...
- Svelte keeps board state in runes, derives visible cards/counts, and uses bindings for editable input state.
